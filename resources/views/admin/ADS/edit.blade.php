            ...
            <form method="POST" action="{{ route("admin.ads.update",$ads->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title"
                        id="title" value="{{ $ads->title }}" required>
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" name="url"
                        id="url" value="{{ $ads->url }}" required>
                    @if ($errors->has('url'))
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" required
                        ...
                        <option {{ $ads->type == 'ADS' ? 'selected' : null }} value="ADS">ADS</option>
                        <option {{ $ads->type == 'slider' ? 'selected' : null }} value="slider">slider</option>
