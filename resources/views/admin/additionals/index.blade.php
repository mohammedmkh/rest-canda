...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Additional">
                <thead>
                    <tr>
                        <th width="10">
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.additionals.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            let table = $('.datatable-Additional').DataTable(dtOverrideGlobals);
