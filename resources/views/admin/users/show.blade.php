...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#user_favorites" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="user_favorites">
            @includeIf('admin.users.relationships.userFavorites', ['favorites' => $user->userFavorites])
        </div>
